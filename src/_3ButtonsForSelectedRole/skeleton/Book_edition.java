...
public class Book_edition {
    ...
    public Book_edition(int id, int id_book, int id_author, String chief_editor, String lead_editor, String corrector, String book_artist, String layouti, int circulationi, String date_coc, int publication_year) {
        this.id = id;
